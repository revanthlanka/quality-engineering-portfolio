 ...
 return <div className="app">
  ...
  <main>
   <section id="home" className="hero"><div className="container hero-grid">
    ...
    <div className="hero-actions"><a className="button primary" href="#experience">View Experience <ArrowRight size={16}/></a><a className="button" href="#stack">Explore Stack</a></div><a href="/Revanth-Lanka-Resume.pdf"  download="Revanth-Lanka-Resume.pdf"  className="btn btn-primary"> <Download size={18} /> Download Resume</a>
